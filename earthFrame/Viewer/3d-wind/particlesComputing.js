...
let _util = new Util();
let _dataProcess = new DataProcess();
export default class ParticlesComputing {
    ...
    createWindTextures(context, data) {
        ...
        this.windTextures = {
            U: _util.createTexture(windTextureOptions, data.U.array),
            V: _util.createTexture(windTextureOptions, data.V.array)
        };
    }
    ...
    createParticlesTextures(context, userInput, viewerParameters) {
        ...
        var particlesArray = _dataProcess.randomizeParticles(userInput.maxParticles, viewerParameters)

        this.particlesTextures = {
            particlesWind: _util.createTexture(particlesTextureOptions),

            currentParticlesPosition: _util.createTexture(particlesTextureOptions, particlesArray),
            nextParticlesPosition: _util.createTexture(particlesTextureOptions, particlesArray),

            currentParticlesSpeed: _util.createTexture(particlesTextureOptions),
            nextParticlesSpeed: _util.createTexture(particlesTextureOptions),

            postProcessingPosition: _util.createTexture(particlesTextureOptions, particlesArray),
            postProcessingSpeed: _util.createTexture(particlesTextureOptions)
        };
    }
        ...
        this.primitives = {
            getWind: new CustomPrimitive({
                ...
                fragmentShaderSource: new Cesium.ShaderSource({
                    sources: [_util.loadText('../../../../../static/SampleData/glsl/getWind.frag')]
                }),
            ...
            updateSpeed: new CustomPrimitive({
                ...
                fragmentShaderSource: new Cesium.ShaderSource({
                    sources: [_util.loadText('../../../../../static/SampleData/glsl/updateSpeed.frag')]
                }),
            ...
            updatePosition: new CustomPrimitive({
                ...
                fragmentShaderSource: new Cesium.ShaderSource({
                    sources: [_util.loadText('../../../../../static/SampleData/glsl/updatePosition.frag')]
                }),
            ...
            postProcessingPosition: new CustomPrimitive({
                ...
                fragmentShaderSource: new Cesium.ShaderSource({
                    sources: [_util.loadText('../../../../../static/SampleData/glsl/postProcessingPosition.frag')]
                }),
            ...
            postProcessingSpeed: new CustomPrimitive({
                ...
                fragmentShaderSource: new Cesium.ShaderSource({
                    sources: [_util.loadText('../../../../../static/SampleData/glsl/postProcessingSpeed.frag')]
                }),
