...
export default class ParticlesRendering {
    ...
    createRenderingTextures(context, data) {
        ...
        this.textures = {
            segmentsColor: _util.createTexture(colorTextureOptions),
            segmentsDepth: _util.createTexture(depthTextureOptions),

            currentTrailsColor: _util.createTexture(colorTextureOptions),
            currentTrailsDepth: _util.createTexture(depthTextureOptions),

            nextTrailsColor: _util.createTexture(colorTextureOptions),
            nextTrailsDepth: _util.createTexture(depthTextureOptions),

            colorTable: _util.createTexture(colorTableTextureOptions, data.colorTable.array)
        };
    }

    createRenderingFramebuffers(context) {
        this.framebuffers = {
            segments: _util.createFramebuffer(context, this.textures.segmentsColor, this.textures.segmentsDepth),
            currentTrails: _util.createFramebuffer(context, this.textures.currentTrailsColor, this.textures.currentTrailsDepth),
            nextTrails: _util.createFramebuffer(context, this.textures.nextTrailsColor, this.textures.nextTrailsDepth)
        }
    }
        ...
        this.primitives = {
            segments: new CustomPrimitive({
                ...
                vertexShaderSource: new Cesium.ShaderSource({
                    sources: [_util.loadText('../../../../../static/SampleData/glsl/segmentDraw.vert')]
                }),
                fragmentShaderSource: new Cesium.ShaderSource({
                    sources: [_util.loadText('../../../../../static/SampleData/glsl/segmentDraw.frag')]
                }),
                rawRenderState: _util.createRawRenderState({
            ...
            trails: new CustomPrimitive({
                ...
                geometry: _util.getFullscreenQuad(),
                primitiveType: Cesium.PrimitiveType.TRIANGLES,
                uniformMap: {
                ...
                vertexShaderSource: new Cesium.ShaderSource({
                    ...
                    sources: [_util.loadText('../../../../../static/SampleData/glsl/fullscreen.vert')]
                }),
                fragmentShaderSource: new Cesium.ShaderSource({
                    defines: ['DISABLE_LOG_DEPTH_FRAGMENT_WRITE'],
                    sources: [_util.loadText('../../../../../static/SampleData/glsl/trailDraw.frag')]
                }),
                rawRenderState: _util.createRawRenderState({
                    viewport: undefined,
                    depthTest: {
            ...
            screen: new CustomPrimitive({
                ...
                fragmentShaderSource: new Cesium.ShaderSource({
                    defines: ['DISABLE_LOG_DEPTH_FRAGMENT_WRITE'],
                    sources: [_util.loadText('../../../../../static/SampleData/glsl/screenDraw.frag')]
                }),
                rawRenderState: _util.createRawRenderState({
                    viewport: undefined,
                    depthTest: {
